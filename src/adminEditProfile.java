...
public class adminEditProfile extends JFrame implements ActionListener {
    ...
    public adminEditProfile(String username) {
        ...
        JLabel pageTitle = new JLabel("My Profile", SwingConstants.CENTER);
        ...
        addProfileRow(personalCard, "Admin ID", idField, 0);
        ...
        roleField = createStyledTextField("Admin");
